 ...
 */
fun angleInRadian(deg: Int, min: Int, sec: Int): Double = ((deg + min * (1 / 60.0) + sec * (1 / 3600.0)) * PI) / 180.0
...
fun trackLength(x1: Double, y1: Double, x2: Double, y2: Double): Double {
    val radius = (x1 - x2).pow(2.0) + (y2 - y1).pow(2.0)
    val len = kotlin.math.sqrt(radius)
    return len
}
